  ...
  <div class="teacher-container">
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="班级及课程" >
        <el-select v-model="classList" multiple placeholder="请选择班级" prop="list" disabled>
          <el-option
        ...
        <el-select v-model="course" multiple placeholder="请选择课程" prop="courseList" disabled>
          <el-option
...
<script>
import { getClassList, getCourseList, saveTeacher, getByToken, updateTeacher } from '@/api/teacher'
