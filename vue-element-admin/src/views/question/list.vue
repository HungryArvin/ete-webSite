<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="问卷发布状态" width="100px">
        <template slot-scope="{row}">
          <el-switch
            v-model="row.status"
            active-color="#13ce66"
      ...
      <el-table-column label="问卷完成数" width="100px" align="center">
...
<script>
import { getList, updateStatus} from '@/api/question'
...
export default {
  ...
  methods: {
    ...
    handleLook(row) {
      ...
      this.$router.push({ path: '/question/info/' + row.id })
    },
